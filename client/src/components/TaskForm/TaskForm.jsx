...
import { capitalize, formatCategory, cleanCategory } from "../../utils/formatters"; // ✅ import cleanCategory
...
function TaskForm({ onCreate }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // ✅ använd cleanCategory + formatCategory
            const cleaned = cleanCategory(category);
            formData.append("category", formatCategory(cleaned));
    ...
    return (
        ...
        >
            ...
            <input
                ...
                value={category}
                onChange={e =>
                    setCategory(cleanCategory(e.target.value)) // ✅ rensar siffror direkt
                }
            />
